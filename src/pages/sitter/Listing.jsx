    ...
    <div className="min-h-screen bg-gradient-to-br from-[#fef5f6] to-[#fcf3f3]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold text-[#3e2d2e]">My Listings</h1>
            <p className="text-[#6d6d6d] mt-1 text-sm sm:text-base">Manage your pet sitting services</p>
          </div>
          <button
