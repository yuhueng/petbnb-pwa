...
/**
 * SitterCard Component - Supports both grid and compact horizontal scroll layouts
 * @param {Object} props
 ...
 * @param {boolean} props.compact - Whether to use compact horizontal scroll layout
 */
const SitterCard = ({ listing, onClick, isInWishlist = false, onToggleWishlist, compact = false }) => {
  const {
    title,
    service_type,
    price_per_day,
  ...
  if (compact) {
    ...
    return (
      ...
      >
        <div className="relative overflow-hidden rounded-xl border border-gray-200 hover:border-gray-300 transition-colors h-full flex flex-col">
          {/* Image Section */}
  ...
  // Default grid layout (original Airbnb style)
  return (
    <div
      onClick={onClick}
